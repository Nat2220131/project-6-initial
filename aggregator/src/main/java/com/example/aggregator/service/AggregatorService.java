...
public class AggregatorService {
    ...
    public List<Entry> getWordsThatContainSuccessiveLettersAndStartsWith(String chars) {
        ...
        List<Entry> wordsThatContainSuccessiveDoubleLetters = restClient.getWordsThatContainConsecutiveDoubleLetters();

        List<Entry> common = new ArrayList<>(wordsThatStartWith);
        common.retainAll(wordsThatContainSuccessiveDoubleLetters);
